...
function NewsListItem({name, description, category, onDelete}) {
  ...
  return (
    <li className={`card flex-row shadow-lg text-white my-2 ${elementClassName}`}>
        ...
        <img src="https://images.unsplash.com/photo-1503694978374-8a2fa686963a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bmV3c3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" 
            alt="News Img" 
